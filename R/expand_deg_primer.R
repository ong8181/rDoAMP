#' @title Automatically expand a primer sequence that contains degenerate bases
#' @description \code{expand_degenerate_primer} Automatically expand a primer sequence that contains degenerate bases
